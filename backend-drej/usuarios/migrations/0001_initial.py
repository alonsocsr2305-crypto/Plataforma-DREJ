# Generated by Django 5.2.7 on 2025-10-30 00:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InstiDireccion', models.CharField(blank=True, max_length=150, null=True)),
                ('InstiDistrito', models.CharField(blank=True, max_length=100, null=True)),
                ('InstiProvincia', models.CharField(blank=True, max_length=100, null=True)),
                ('InstiRegion', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
